package com.yanchware.fractal.samples.azure.servicebus.full;
...
import static com.yanchware.fractal.samples.azure.servicebus.full.components.AzServiceBus.getServiceBus;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-servicebus-full-sample";
