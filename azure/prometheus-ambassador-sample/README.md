...
The purpose of this project is to show the instantiation of Prometheus alongside Ambassador in AKS.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/azure.prometheus.ambassador.sample-2.0.0.jar
```
