...
import static com.yanchware.fractal.samples.azure.aks.full.components.AksComponent.getAks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-aks-full-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getAks("aks-full-1", RESOURCE_GROUP))
