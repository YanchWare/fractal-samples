package com.yanchware.fractal.samples.azure.ambassador;
...
import static com.yanchware.fractal.samples.azure.ambassador.components.AksComponent.getAks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-ambassador-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getAks("aks-ambassador-1", RESOURCE_GROUP))
