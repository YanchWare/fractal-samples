...
The purpose of this project is to show an example of instantiating a AKS cluster with Ambassador as API Gateway.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/azure.aks.ambassador.sample-2.0.0.jar
```
