...
public class AzureTestConstants {
  ...
  public static final EnvVarRecord AZURE_RESOURCE_GROUP_REGION_ENV = new EnvVarRecord("AZURE_RESOURCE_GROUP_REGION", "westeurope");
  public static final EnvVarRecord AZURE_REGION_ENV = new EnvVarRecord("AZURE_REGION", "westeurope");
