package com.yanchware.fractal.samples.azure.appservice;
...
import static com.yanchware.fractal.samples.azure.appservice.components.WebAppComponent.getJavaWebAppComponent;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-appservice-sample";
