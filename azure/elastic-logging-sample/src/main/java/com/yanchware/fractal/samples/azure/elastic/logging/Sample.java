package com.yanchware.fractal.samples.azure.elastic.logging;
...
import static com.yanchware.fractal.samples.azure.elastic.logging.components.AksComponent.getAks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-elastic-logging-sample";
...
automaton.instantiate(List.of(getLiveSystem(automaton, configuration)), instantiationConfig);
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getAks("aks-elastic-logging-1", RESOURCE_GROUP))
