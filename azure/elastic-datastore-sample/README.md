...
The purpose of this project is to show an example of instantiating a AKS cluster with Elastic Datastore as a Document Storage solution.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/azure.elastic.datastore.sample-2.0.0.jar
```
