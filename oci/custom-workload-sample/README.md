# Custom Workload in OKE Sample

## Introduction

The purpose of this project is to show the instantiation of Custom Workload in OKE.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/oci.custom.workload.sample-2.0.0.jar
```
