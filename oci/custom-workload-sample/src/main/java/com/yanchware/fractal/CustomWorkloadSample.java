...
import static com.yanchware.fractal.oci.customworkload.sample.components.OkeComponent.getOkeWithCustomWorkload;
...
public class CustomWorkloadSample {
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getOkeWithCustomWorkload("oke-custom-workload-1", configuration.getCompartment(), configuration.getOciRegion()))
        .build();
  }
}