...
import static com.yanchware.fractal.samples.oci.customworkload.components.OkeComponent.getOkeWithCustomWorkload;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "oci-custom-workload-sample";
