package com.yanchware.fractal.samples.oci.elastic.datastore;
...
import static com.yanchware.fractal.samples.oci.elastic.datastore.components.OkeComponent.getOkeWithElasticDatastore;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "oci-elastic-datastore-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getOkeWithElasticDatastore("oke-elastic-datastore-1", configuration.getOciCompartment(), REGION))
