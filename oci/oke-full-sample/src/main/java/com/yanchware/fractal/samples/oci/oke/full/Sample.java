package com.yanchware.fractal.samples.oci.oke.full;
...
import static com.yanchware.fractal.samples.oci.oke.full.components.OkeComponent.getOke;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "oci-oke-full-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getOke("oke-full-1", configuration.getOciCompartment(), REGION))
