# OKE with minimum requirements sample 

## Introduction

The purpose of this project is to test the instantiation of a OKE cluster using the minimum requirements. For this example, we will mostly rely on the default settings used by [Fractal Cloud](https://fractal.cloud).
