package com.yanchware.fractal.samples.oci.ambassador;
...
import static com.yanchware.fractal.samples.oci.ambassador.components.OkeComponent.getOke;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "oci-ambassador-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getOke("oke-ambassador-1", configuration.getOciCompartment(), REGION))
