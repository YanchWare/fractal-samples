...
import static com.yanchware.fractal.aws.eks.full.sample.components.EksComponent.getEks;

public class EksFullSample {
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getEks("eks-full-1", configuration.getAwsRegion()))
