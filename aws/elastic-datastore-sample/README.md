...
The purpose of this project is to show an example of instantiating a EKS cluster with Elastic Datastore as a Document Storage solution.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/aws.elastic.datastore.sample-2.0.0.jar
```
