...
The purpose of this project is to show an example of instantiating a EKS cluster with ECK (Elastic, Kibana, APM, Fluentd) as a Logging solution.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/aws.elastic.logging.sample-2.0.0.jar
```
