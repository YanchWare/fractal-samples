package com.yanchware.fractal.samples.aws.eks.minimum;
...
import static com.yanchware.fractal.samples.aws.eks.minimum.components.EksComponent.getEks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "aws-eks-minimum-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getEks("eks-minimum-1", REGION))
