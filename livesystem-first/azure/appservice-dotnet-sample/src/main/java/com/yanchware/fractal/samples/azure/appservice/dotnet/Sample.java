package com.yanchware.fractal.samples.azure.appservice.dotnet;
...
import static com.yanchware.fractal.samples.azure.appservice.dotnet.components.WebAppComponent.getDotnetWebAppComponent;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-appservice-dotnet-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    ...
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getDotnetWebAppComponent("app-dotnet-fractal-cloud-demo", RESOURCE_GROUP))
