package com.yanchware.fractal.samples.azure.relay;
...
import static com.yanchware.fractal.samples.azure.relay.components.Relay.getRelay;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-relay-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getRelay(RESOURCE_GROUP))
