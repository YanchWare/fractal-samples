package com.yanchware.fractal.samples.azure.postgres;
...
import static com.yanchware.fractal.samples.azure.postgres.components.PostgreSqlComponent.getDbmsAndDatabase;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-postgres-sample";
