package com.yanchware.fractal.samples.azure.prometheus.ambassador;
...
import static com.yanchware.fractal.samples.azure.prometheus.ambassador.components.AksComponent.getAks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-prometheus-ambassador-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getAks("aks-prometheus-ambassador-1", RESOURCE_GROUP))
