package com.yanchware.fractal.samples.azure.elastic.logging.ambassador;
...
import static com.yanchware.fractal.samples.azure.elastic.logging.ambassador.components.AksComponent.getAks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-elastic-logging-ambassador-sample";
...
automaton.instantiate(List.of(getLiveSystem(automaton, configuration)), instantiationConfig);
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getAks("aks-ambassador-elastic-logging-1", RESOURCE_GROUP))
