...
import static com.yanchware.fractal.samples.azure.customworkload.components.AksComponent.getAksWithCustomWorkload;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-custom-workload-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getAksWithCustomWorkload("aks-custom-workload-1", RESOURCE_GROUP))
