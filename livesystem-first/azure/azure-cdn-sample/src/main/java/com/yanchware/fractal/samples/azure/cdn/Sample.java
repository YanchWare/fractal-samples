package com.yanchware.fractal.samples.azure.cdn;
...
import static com.yanchware.fractal.samples.azure.cdn.components.CdnComponent.getFullComponent;
import static com.yanchware.fractal.samples.azure.cdn.components.CdnComponent.getMinimalComponent;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-cdn-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    ...
    return automaton.getLiveSystemBuilder()
        ...
        .withComponents(List.of(
            getMinimalComponent("cdn-minimal", RESOURCE_GROUP),
            getFullComponent("cdn-front-door", RESOURCE_GROUP)))
