package com.yanchware.fractal.samples.azure.aks.minimum;
...
import static com.yanchware.fractal.samples.azure.aks.minimum.components.AksComponent.getAks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-aks-minimum-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getAks("aks-minimum-1", RESOURCE_GROUP))
