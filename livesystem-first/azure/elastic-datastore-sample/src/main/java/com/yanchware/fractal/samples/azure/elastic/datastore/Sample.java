package com.yanchware.fractal.samples.azure.elastic.datastore;
...
import static com.yanchware.fractal.samples.azure.elastic.datastore.components.AksComponent.getAks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "azure-elastic-datastore-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getAks("aks-elastic-datastore-1", RESOURCE_GROUP))
