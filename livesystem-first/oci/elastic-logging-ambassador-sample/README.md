...
The purpose of this project is to show an example of instantiating a OKE cluster with ECK (Elastic, Kibana, APM, Fluentd) as a Logging solution and Ambassador as API Gateway.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/oci.elastic.logging.ambassador.sample-2.0.0.jar
```
