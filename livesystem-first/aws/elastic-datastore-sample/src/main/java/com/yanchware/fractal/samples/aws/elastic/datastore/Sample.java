package com.yanchware.fractal.samples.aws.elastic.datastore;
...
import static com.yanchware.fractal.samples.aws.elastic.datastore.components.EksComponent.getEksWithElasticDatastore;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "aws-elastic-datastore-sample";
...
automaton.instantiate(List.of(getLiveSystem(automaton, configuration)), instantiationConfig);
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getEksWithElasticDatastore("eks-elastic-datastore-1", REGION))
