# EKS with all possible options sample 

## Introduction

The purpose of this project is to show the instantiation of a EKS cluster using all options available.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/aws.eks.full.sample-2.0.0.jar
```
