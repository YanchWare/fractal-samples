...
import static com.yanchware.fractal.samples.aws.ambassador.components.EksComponent.getEks;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "aws-ambassador-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getEks("eks-ambassador-1", REGION))
