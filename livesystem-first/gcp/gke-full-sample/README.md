...
The purpose of this project is to show the instantiation of a GKE cluster using all options available.
...
FRACTAL_RESOURCE_GROUP_ID="xxxx" \
    ...
    java -jar build/libs/gcp.gke.full.sample-2.0.0.jar
```
