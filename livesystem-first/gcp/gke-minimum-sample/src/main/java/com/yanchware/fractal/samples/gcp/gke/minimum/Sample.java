package com.yanchware.fractal.samples.gcp.gke.minimum;
...
import static com.yanchware.fractal.samples.gcp.gke.minimum.components.GkeComponent.getGke;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "gcp-gke-minimum-sample";
