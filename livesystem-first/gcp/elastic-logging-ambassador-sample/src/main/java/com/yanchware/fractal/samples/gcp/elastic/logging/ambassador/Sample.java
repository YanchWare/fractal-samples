package com.yanchware.fractal.samples.gcp.elastic.logging.ambassador;
...
import static com.yanchware.fractal.samples.gcp.elastic.logging.ambassador.components.GkeComponent.getGke;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "gcp-elastic-logging-ambassador-sample";
