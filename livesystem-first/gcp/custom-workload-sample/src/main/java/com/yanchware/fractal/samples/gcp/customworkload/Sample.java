package com.yanchware.fractal.samples.gcp.customworkload;
...
import static com.yanchware.fractal.samples.gcp.customworkload.components.GkeComponent.getGke;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "gcp-customworkload-sample";
