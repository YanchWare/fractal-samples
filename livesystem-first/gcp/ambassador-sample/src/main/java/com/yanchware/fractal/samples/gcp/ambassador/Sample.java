package com.yanchware.fractal.samples.gcp.ambassador;
...
import static com.yanchware.fractal.samples.gcp.ambassador.components.GkeComponent.getGke;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "gcp-ambassador-sample";
