package com.yanchware.fractal.samples.gcp.postgresql;
...
import static com.yanchware.fractal.samples.gcp.postgresql.components.PostgreSqlComponent.getDbmsAndDatabase;

public class Sample {
  protected static final String LIVE_SYSTEM_NAME = "gcp-postgres-sample";
  ...
  public static LiveSystemAggregate getLiveSystem(Automaton automaton, SharedConfig configuration) throws InstantiatorException {
    return automaton.getLiveSystemBuilder()
        ...
        .withComponent(getDbmsAndDatabase("postrgresql-1", REGION))
