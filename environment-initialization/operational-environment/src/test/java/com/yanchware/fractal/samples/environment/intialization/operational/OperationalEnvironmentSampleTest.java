...
import static com.yanchware.fractal.samples.environment.intialization.operational.OperationalEnvironmentSample.getFractalCloudEnvironment;
...
class OperationalEnvironmentSampleTest extends BaseTest {
    @Test
    void should_createEnvironment_withValidData() throws InstantiatorException {
        // Arrange
        ...
        assertThat(managementEnvironment.getDefaultCiCdProfile()).isNull();
    }
