...
public class EnvVarConfiguration implements Configuration {
  ...
  @Override
  public AzureRegion getOperationalEnvironmentAzureRegion() {
    return AzureRegion.fromString(getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_AZURE_REGION_ENV_VAR_KEY));
  }

  @Override
  public UUID getOperationalEnvironmentAzureSubscriptionId() {
    return UUID.fromString(getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_AZURE_SUBSCRIPTION_ID_ENV_VAR_KEY));
  }

  @Override
  public CiCdProfile getOperationalEnvironmentDefaultCiCdProfile() {
    return new CiCdProfile(
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_DEFAULT_CI_CD_PROFILE_SHORT_NAME_ENV_VAR_KEY),
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_DEFAULT_CI_CD_PROFILE_DISPLAY_NAME_ENV_VAR_KEY),
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_DEFAULT_CI_CD_PROFILE_DESCRIPTION_ENV_VAR_KEY),
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_DEFAULT_CI_CD_PROFILE_SSH_PRIVATE_KEY_DATA_ENV_VAR_KEY),
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_DEFAULT_CI_CD_PROFILE_SSH_PRIVATE_KEY_PASSPHRASE_ENV_VAR_KEY)
    );
  }

  @Override
  public String getOperationalEnvironmentShortName() {
    return getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_SHORT_NAME_ENV_VAR_KEY);
  }

  @Override
  public String getOperationalEnvironmentName() {
    return getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_NAME_ENV_VAR_KEY);
  }
  ...
  @Override
  public Secret getOperationalEnvironmentSecret() {
    return new Secret(
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_SECRET_SHORT_NAME_ENV_VAR_KEY),
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_SECRET_DISPLAY_NAME_ENV_VAR_KEY),
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_SECRET_DESCRIPTION_ENV_VAR_KEY),
            getVariableValue(Constants.OPERATIONAL_ENVIRONMENT_SECRET_VALUE_ENV_VAR_KEY)
    );
  }
