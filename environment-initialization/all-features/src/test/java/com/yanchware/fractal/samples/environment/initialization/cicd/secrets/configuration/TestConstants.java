package com.yanchware.fractal.samples.environment.initialization.cicd.secrets.configuration;

import com.yanchware.fractal.samples.environment.initialization.cicd.secrets.EnvVarRecord;
import com.yanchware.fractal.samples.environment.initialization.cicd.secrets.Utils.TestUtils;

import java.util.UUID;

import static com.yanchware.fractal.samples.environment.initialization.cicd.secrets.configuration.Constants.*;
...
public class TestConstants {
  ...
  public static final EnvVarRecord FIRST_SECRET_SHORT_NAME_ENV_VAR =
          new EnvVarRecord(FIRST_SECRET_SHORT_NAME_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord FIRST_SECRET_DISPLAY_NAME_ENV_VAR =
          new EnvVarRecord(FIRST_SECRET_DISPLAY_NAME_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord FIRST_SECRET_DESCRIPTION_ENV_VAR =
          new EnvVarRecord(FIRST_SECRET_DESCRIPTION_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord FIRST_SECRET_VALUE_ENV_VAR =
          new EnvVarRecord(FIRST_SECRET_VALUE_ENV_VAR_KEY, UUID.randomUUID().toString());
  ...
  public static final EnvVarRecord SECOND_SECRET_SHORT_NAME_ENV_VAR =
          new EnvVarRecord(SECOND_SECRET_SHORT_NAME_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord SECOND_SECRET_DISPLAY_NAME_ENV_VAR =
          new EnvVarRecord(SECOND_SECRET_DISPLAY_NAME_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord SECOND_SECRET_DESCRIPTION_ENV_VAR =
          new EnvVarRecord(SECOND_SECRET_DESCRIPTION_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord SECOND_SECRET_VALUE_ENV_VAR =
          new EnvVarRecord(SECOND_SECRET_VALUE_ENV_VAR_KEY, UUID.randomUUID().toString());
  ...
  public static final EnvVarRecord THIRD_SECRET_SHORT_NAME_ENV_VAR =
          new EnvVarRecord(THIRD_SECRET_SHORT_NAME_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord THIRD_SECRET_DISPLAY_NAME_ENV_VAR =
          new EnvVarRecord(THIRD_SECRET_DISPLAY_NAME_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord THIRD_SECRET_DESCRIPTION_ENV_VAR =
          new EnvVarRecord(THIRD_SECRET_DESCRIPTION_ENV_VAR_KEY, UUID.randomUUID().toString());

  public static final EnvVarRecord THIRD_SECRET_VALUE_ENV_VAR =
          new EnvVarRecord(THIRD_SECRET_VALUE_ENV_VAR_KEY, UUID.randomUUID().toString());
}
