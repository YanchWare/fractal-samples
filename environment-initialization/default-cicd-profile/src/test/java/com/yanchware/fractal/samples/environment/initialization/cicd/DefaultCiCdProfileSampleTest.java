...
import static com.yanchware.fractal.samples.environment.initialization.cicd.DefaultCiCdProfileSample.getFractalCloudEnvironment;
...
class DefaultCiCdProfileSampleTest extends BaseTest {
    @Test
